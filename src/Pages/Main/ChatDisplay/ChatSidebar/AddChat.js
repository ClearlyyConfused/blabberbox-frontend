...
function AddChat({userInfo, fetchUserChats}) {
    ...
    if (formDisplay === "create chat") {
        return <ChatCreateForm userInfo={userInfo} fetchUserChats={fetchUserChats} setFormDisplay={setFormDisplay}/>
    }
    if (formDisplay === "join chat") {
        return <ChatJoinForm  userInfo={userInfo} fetchUserChats={fetchUserChats} setFormDisplay={setFormDisplay}/>
    }

    return (<section className="add-chat">
